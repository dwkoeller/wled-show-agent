...
router.add_api_route("/api/wled/preview", wled_service.wled_preview_state, methods=["POST"])
router.add_api_route("/api/wled/undo", wled_service.wled_undo_state, methods=["POST"])
router.add_api_route("/api/wled/discover", wled_service.wled_discover, methods=["POST"])
router.add_api_route("/api/wled/calibration", wled_service.wled_calibration, methods=["GET"])
router.add_api_route("/api/wled/calibration", wled_service.wled_apply_calibration, methods=["POST"])
